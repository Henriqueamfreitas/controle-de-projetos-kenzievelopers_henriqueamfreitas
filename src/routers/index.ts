...
exemploRouter7.get('/:id', ensureProjectIdExistsMiddleWare, getProject)
exemploRouter8.patch('/:id', ensureProjectIdExistsMiddleWare, ensureDeveloperIdExistsMiddleWare, updatedProject)


export { 
        exemploRouter1, exemploRouter2, exemploRouter3, exemploRouter4, exemploRouter5,
        exemploRouter6, exemploRouter7, exemploRouter8 
}